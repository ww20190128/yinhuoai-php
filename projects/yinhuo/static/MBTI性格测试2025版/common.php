...
<p style="text-align: center;">所有内容基于卡尔·荣格 (Carl Jung) 和伊莎贝尔·布里格斯·迈尔斯 (lsabel Briggs Myers)的MBTI理论实证</p>
BLOCK;
...
// 支付确认描述
$payConfirmDec = <<<BLOCK
<p style="text-wrap: wrap;">你的测评报告全文超过<span style="color: rgb(246, 114, 126);">5000</span>字！含MBTI人格类型评估与分析、恋爱性格分析、爱情婚姻走向、职场性格分析、职业天赋评估、专属心理学建议等<span style="color: rgb(246, 114, 126);">20项</span>专业模块。</p>
