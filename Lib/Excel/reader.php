...
//        var_dump($res);
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_XF:
                    ...
                    if (array_key_exists($indexCode, $this->dateFormats)) {
                        ...
                        if ($indexCode > 0) {
                            ...
                            //echo '.other.';
                            //echo "\ndate-time=$formatstr=\n";
                            if (isset($formatstr) && $formatstr && preg_match("/[^hmsday\/\-:\s]/i", $formatstr) == 0) {
        ...
        while($cont) {
            ...
            switch ($code) {
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_LABELSST:
                        ...
                        /*
                        if (!isset($this->sst[$index])) {
                            var_dump($this->sst);exit;
                        }
                        */
    ...
    function _encodeASCII($string)
    {
        ...
        if ($this->_defaultEncoding){
            switch ($this->_encoderFunction){
                case 'iconv' :
                    $result = iconv("ASCII", $this->_defaultEncoding, $string);
                    break;
                case 'mb_convert_encoding' :
                    $result = mb_convert_encoding($string, $this->_defaultEncoding, "ASCII");
                    break;
            }
        }
        return $result;
