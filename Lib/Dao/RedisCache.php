...
class RedisCache
{
    ...
    public function __construct(array $args)
    {
    	...
    	$this->cachePrefix = (empty($args['cachePrefix']) ? 'cachePrefix' : $args['cachePrefix']) . ':'; // 缓存前缀
    	if ($switch) {
    		$switch = $this->connect();
        }
        $this->reset();
